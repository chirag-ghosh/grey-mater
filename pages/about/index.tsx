        ...
        <div className="about">
            <div className="biodata section">
                ...
                <div className="subtitle">
                    An undergrad from IIT Kharagpur currently working at Amex.
                </div>
            ...
            <div className="text section">
                <p>Hello There....</p>
                <p>At the time of writing this, I have moved past the world of algorithms and web development.</p>
                <p>I hate CP (and will always do) although I find DSA intriguing. I find the open source community awesome and starting to contribute in it. In my free time, I binge tech and cooking videos in youtube or watch a tv-series (mostly drama and comedy). I am a huge fan of friends and its the goto spot whenever I do not feel good.</p>
