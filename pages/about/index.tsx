    ...
    return (
        <div className="about">
            ...
            <div className="text section">
                ...
                <p>I hate CP although I find DSA intriguing. I find the open source community awesome and starting to contribute in it. In my free time, I binge tech and cooking videos in youtube or watch a tv-series (mostly drama and comedy). I am a huge fan of friends and its the goto spot whenever I don't feel good.</p>
